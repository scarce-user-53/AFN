"""
Script for training the AFN model
"""
...
def train_model(
    ...
    """Trains the AFN model.
    Params:
        model (AFN): AFN model to train.
        ...
        latent_dim (int): Dimensionality of the AFN's latent space.
